...
csv_path = r"/Users/niwatorimostiqo/Desktop/Coding/Mitou-Fukuoka/tests/csv_s/example_login_test.csv"
    ...
    async with async_playwright() as playwright:
        ...
        for index, row in df.iterrows():
            ...
            try:
                ...
                assert expected_username_status.lower() in actual_username_status_str.lower() or actual_username_status_str.lower() in expected_username_status.lower(), \
                    f"Username status mismatch for input '{username_value}'. Expected '{expected_username_status}', Got '{actual_username_status_str}'"
